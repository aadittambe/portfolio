...
function Hero() {
    return (
        <div className='hero'>
            ...
            <p> If you like to keep up with current events and care about the news experience — or want to simply chat about trains or nerd out about antique fountain pens — we should connect!</p>
