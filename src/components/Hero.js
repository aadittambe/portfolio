...
function Hero() {
    ...
    return (
        ...
        <main className='hero'>
            ...
            <p>Currently, I work on the news design team at The Washington Post. Previosuly, I was a data reporting fellow at the Howard Center for Investigative Journalism at the University of Maryland, and have interned at NBC News on the data and graphics team. My code contributions on GitHub in the last year look like this <span id='sparklines'></span>.</p>
